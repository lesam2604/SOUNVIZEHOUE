      ...
      <ul class="nav nav-pills" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
          <a class="nav-link active" id="tabOperations" data-bs-toggle="tab" href="#operations" role="tab"
            aria-controls="operations" aria-selected="true">Gestion des opérations</a>
        </li>
                ...
                <div class="card-body px-4 py-4">
                  <div class="row">
                    ...
                    <div class="col-9">
                      ...
                      <h6 class="font-extrabold mb-0" id="card_categories">0</h6>
                      <div class="text-end">
                        <a href="/card-categories" title="Accéder a la liste"
                          class="card-link btn btn-sm btn-outline-primary"><i class="fas fa-list"></i></a>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card">
                <div class="card-body px-4 py-4">
                  <div class="row">
                    ...
                    <div class="col-9">
                      <h6 class="text-muted font-semibold">Cartes</h6>
                      <h6 class="font-extrabold mb-0" id="cards">0</h6>
                      <div class="text-end">
                        <a href="/cards" title="Accéder a la liste"
                          class="card-link btn btn-sm btn-outline-primary"><i class="fas fa-list"></i></a>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card">
                <div class="card-body px-4 py-4">
                  <div class="row">
                    ...
                    <div class="col-9">
                      <h6 class="text-muted font-semibold">Collaborateurs actifs</h6>
                      <h6 class="font-extrabold mb-0" id="collab_enabled">0</h6>
                      <div class="text-end">
                        <a href="/collabs/enabled" title="Accéder a la liste"
                          class="card-link btn btn-sm btn-outline-primary"><i class="fas fa-list"></i></a>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card">
                <div class="card-body px-4 py-4">
                  <div class="row">
                    ...
                    <div class="col-9">
                      <h6 class="text-muted font-semibold">Collaborateurs désactivés</h6>
                      <h6 class="font-extrabold mb-0" id="collab_disabled">0</h6>
                      <div class="text-end">
                        <a href="/collabs/disabled" title="Accéder a la liste"
                          class="card-link btn btn-sm btn-outline-primary"><i class="fas fa-list"></i></a>
                      </div>
                    </div>
                  </div>
