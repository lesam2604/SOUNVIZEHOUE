...
@section('pageContent')
  <div class="card mb-3">
    <div class="card-header d-flex align-items-center">
      ...
      <a class="btn btn-outline-primary ms-auto" href="/decoders">
        <i class="fas fa-list"></i> Liste des décodeurs reconnus
      </a>
    </div>
...
@section('pageJs')
  @vite('resources/js/decoders/view.js')
@endsection
