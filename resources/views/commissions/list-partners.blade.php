...
@section('pageTitle', 'Commissions du partenaire')
...
@section('pageContent')
  <div class="card">
    <div class="card-header d-flex align-items-center">
      <h4 class="mb-0">Commissions du partenaire: Total <span class="text-danger" id="total">0</span> FCFA</h4>
    </div>
    <div class="card-body">
...
@section('pageJs')
  @vite('resources/js/commissions/list-partners.js')
@endsection
